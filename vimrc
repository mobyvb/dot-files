...
" Setting up Vundle - the vim plugin bundler
    ...
    "Bundle 'scrooloose/syntastic' "issues with .vue files
...
autocmd BufRead,BufNewFile *.cc setlocal shiftwidth=4 tabstop=4
autocmd BufRead,BufNewFile *.c setlocal shiftwidth=4 tabstop=4
